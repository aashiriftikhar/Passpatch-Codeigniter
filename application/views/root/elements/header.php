<header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url(); ?>root/Home" class="logo">      
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						...
						<span class="hidden-xs"><?php echo "Root User"; ?></span>
					</a>
					<ul class="dropdown-menu">
						...
						<li class="user-footer">
							...
							<div class="pull-right">
								<a href="<?php echo base_url(); ?>root/Home/logout" class="btn btn-default btn-flat btn-modify">Sign out</a>
							</div>
						</li>
					</ul>
				</li>
