                ...
                <div class="row">
                  <div class="col-md-5">
                    <select class="form-control" name="from_device_id">
                      ...
                      <option <?php if(!empty($GroupData['from_device_id'])){ echo ($GroupData['from_device_id']==$value['id'])? "selected": ""; } ?> value="<?= $value['id']?>"><?= $value['device_id']?></option>
                      <? } ?>
                    </select>
                  ...
                  <div class="col-md-5">
                    <select class="form-control" name="to_device_id">
                      <option value="">Select</option>
                      <?php foreach ($ClientMACIdData as $key => $value) { ?>
                      <option <?php if(!empty($GroupData['to_device_id'])){ echo ($GroupData['to_device_id']==$value['id'])? "selected": ""; } ?> value="<?= $value['id']?>"><?= $value['device_id']?></option>
                      <? } ?>
                    </select>
            ...
            <div class="row">
              ...
              <div class="col-md-2" style="margin-bottom: -20px!important;">
                <div class="form-group" style="margin-top: 20px">
                  <label>  </label>
                  <input type="submit" name="userSubmit" class="btn btn-primary  btn-modify pull-right" value="Submit"/>
                </div>
              </div>
            </div>
          </div>
