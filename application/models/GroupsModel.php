	...
	public function getRows($params = array()){
		...
		if(!empty($params['searchKeyword'])){
			...
			$this->db->where("(
                ...
                name LIKE '%".$params['searchKeyword']."%' OR
                location LIKE '%".$params['searchKeyword']."%' OR
                description LIKE '%".$params['searchKeyword']."%' OR
                generalUnit_device_id_from LIKE '%".$params['searchKeyword']."%' OR
                generalUnit_device_id_to LIKE '%".$params['searchKeyword']."%' OR
                fixUnit_device_id_from LIKE '%".$params['searchKeyword']."%' OR
                fixUnit_device_id_to LIKE '%".$params['searchKeyword']."%' OR
